...
filepath_stored_gl = ['Output files/',timestamp_gl];
...
lower_bounds = [prctile(ration,alpha);prctile(ratiob,alpha)];
upper_bounds = [prctile(ration,100-alpha);prctile(ratiob,100-alpha)];
...
table_new = table(["Non-Enhancing";"Brain"],[valn;valb],lower_bounds,upper_bounds);
